BEGIN TRANSACTION;CREATE TABLE "Crêpes" (
	"id"	INTEGER,
	...
	"colour"	TEXT,
	PRIMARY KEY("id")
);INSERT INTO "Crêpes" VALUES(2,'Zimt & Zucker',2.5,'[''Zucker'',''Zimt'']','236,239,64');INSERT INTO "Crêpes" VALUES(3,'Schoko',3.0,'[''Schokolade'',''Schokolade'']','236,239,64');INSERT INTO "Crêpes" VALUES(4,'Apfelmuß & Zimt',3.0,'[''Apfelmuß'',''Zimt'']','236,239,64');INSERT INTO "Crêpes" VALUES(5,'Schoko & Banane',3.5,'[''abc'',''abc'']','236,239,64');INSERT INTO "Crêpes" VALUES(6,'Kinderschokolade',3.5,'[''Kinder'',''Schokolade'']','236,239,64');INSERT INTO "Crêpes" VALUES(7,'Käse',3.0,'[''Käse'', ''Käse'']','86,110,64');INSERT INTO "Crêpes" VALUES(8,'Schinken',3.0,'[''Schinken'', ''Schinken'']','86,110,64');INSERT INTO "Crêpes" VALUES(9,'Käse & Schinken',3.5,'[''abc'', ''abc'']','86,110,64');INSERT INTO "Crêpes" VALUES(10,'Spezial',4.0,'[''Spezi'', ''Aal'']','86,110,64');INSERT INTO "Crêpes" VALUES(11,'Pizza',4.5,'[''Pizza'', ''Pizza'']','86,110,64');INSERT INTO "Crêpes" VALUES(12,'Italiano',4.5,'[''🍕'', ''🍕'']','86,110,64');INSERT INTO "Crêpes" VALUES(13,'Crêpe Natur',2.0,'[''🌲'', ''🌲'']','255,255,255');INSERT INTO "Crêpes" VALUES(14,'Jahrescrêpes ''Raphael''',3.5,'[''🌲'', ''🌲'']','91,55,87');INSERT INTO "Crêpes" VALUES(15,'test',123.0,'[''bbb'', ''aaa'']','255,255,255');INSERT INTO "Crêpes" VALUES(16,'KRASSCRÊPES',1000.0,'[''nutella'', ''teig'', ''kotze'']','#FF1B1C');CREATE TABLE "secret_keys" (
	"ID"	INTEGER,
	"s_key"	text,
